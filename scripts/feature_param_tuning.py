...
from form import extract_keypoints_separate, KeypointExtractionParams_separate
...
def update_keypoints(
    ...
    params_extract = KeypointExtractionParams_separate()
    ...
    planar, normals, points = extract_keypoints_separate(
        scan,  # type: ignore
        params_extract,
        params_lidar,
    )
...
# name, min, max, step
params = KeypointExtractionParams_separate()
sliders = [
